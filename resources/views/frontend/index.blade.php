    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                <h5>Hubungi Kami</h5>
                <p>Email: amosaleksiatoziliwu@gmail.com</p>
                <p>Telepon: +62 822 7562 5828</p>
            </div>
            <div class="col-md-4 mb-4 mb-md-0">
                <h5>Tautan Cepat</h5>
            ...
            <div class="col-md-4">
                <h5>Ikuti Kami</h5>
                <div class="d-flex">
                    <a href="https://www.facebook.com/zil.amosas" class="text-light me-3" aria-label="Facebook">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/in/amos-aleksiato-ziliwu-028840293/" class="text-light me-3" aria-label="LinkedIn">
                        <svg fill="currentColor" width="28" height="28" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.facebook.com/zil.amosas" class="text-light" aria-label="Instagram">
